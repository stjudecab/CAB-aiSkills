...
Packaging, documentation, and scripts (except upstream-noted files): **[CC BY-NC-SA 4.0](../LICENSE.txt)**. See [AUTHORS.md](../AUTHORS.md) and [SKILL.md](SKILL.md) frontmatter.
